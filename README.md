...
### 主界面 - 音乐库
![主界面](![输入图片说明](![输入图片说明](f8103e1ed70f6754d0b16401233eb155.png)))
...
### 沉浸式歌词视图
![沉浸式歌词可视化](![输入图片说明](4324445526f129ce390a22cf6c9e6402.png))
...
- **智能歌词系统**: 支持多格式歌词，自动同步显示
- **个性化设置**: 软膜联动动画等独特交互效果可自定义
