...
export default function PlaybackSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {/* 音频故障排除工具 */}
        <div className="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20 border border-blue-200 dark:border-blue-700/50 rounded-lg p-4 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-green-600 dark:bg-green-500 hover:bg-green-700 disabled:bg-slate-400 text-white text-sm font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-md hover:shadow-lg disabled:cursor-not-allowed"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center py-6 bg-slate-50 dark:bg-dark-300 rounded-lg mt-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-brand-100 dark:bg-brand-900/40 text-brand-700 dark:text-brand-300 rounded-lg text-sm font-medium">
            即将推出
          </div>
          <p className="text-slate-600 dark:text-dark-700 text-sm mt-2">
            设备选择、采样率等设置正在开发中
          </p>
        </div>
      </SettingSection>
